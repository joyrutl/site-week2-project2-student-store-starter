...
export default function Sidebar(props) {
  ...
  <div className="sidebar">
    ...
    {sidebarOpen ? (
      ...
      <li> <i class="material-icons md-48">add_shopping_cart</i> </li>
      <li><i class="material-icons md-48">monetization_on</i></li>
      <li><i class="material-icons md-48">fact_check</i></li>
      </div>
    )
  }
  </div>
